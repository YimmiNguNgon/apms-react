...
export const ROLE_PAGES: Record<Role, string[]> = {
  ...
  [ROLES.OWNER]: ['owner-dashboard', 'partner-ecosystem', 'competitor-intelligence', 'relationship-map', 'crawler-control', 'project-management', 'project-detail', 'company-profiles', 'companies', 'company-detail', 'score-rules', 'audit-logs', 'system-settings', 'news', 'profile', 'system-chat'],
