...
export const ROLE_PAGES: Record<Role, string[]> = {
  [ROLES.ADMIN]: ['admin-dashboard', 'users', 'permissions', 'access-control', 'audit-logs', 'crawler-control', 'owner-company-profile', 'admin-company-profiles', 'admin-company-profile-detail', 'profile', 'system-chat', 'news', 'article-detail', 'company-profiles', 'companies', 'company-detail', 'partner-ecosystem'],
