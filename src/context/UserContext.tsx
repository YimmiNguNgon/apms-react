...
export const ROLE_PAGES: Record<Role, string[]> = {
  [ROLES.ADMIN]: ['admin-dashboard', 'users', 'roles', 'permissions', 'access-control', 'activity-history', 'audit-logs', 'system-settings', 'security-settings', 'crawler-control', 'profile', 'system-chat', 'news', 'article-detail', 'company-profiles', 'companies', 'company-detail', 'relationship-assessment-detail', 'partner-ecosystem', 'owner-profile', 'company-monitoring', 'owner-company-profile', 'admin-my-enterprise'],
  [ROLES.OWNER]: ['owner-dashboard', 'partner-ecosystem', 'competitor-intelligence', 'relationship-map', 'project-detail', 'company-profiles', 'companies', 'my-companies', 'company-detail', 'relationship-assessment-detail', 'news', 'article-detail', 'profile', 'system-chat', 'owner-profile', 'owner-internal-news'],
  [ROLES.MANAGER]: ['manager-dashboard', 'partner-evaluation', 'competitor-intelligence', 'company-assignment', 'analysis-history', 'risk-monitoring', 'partner-status', 'suggested-actions-approval', 'team-kpi', 'reports', 'companies', 'my-companies', 'company-profiles', 'company-detail', 'relationship-assessment-detail', 'partner-ecosystem', 'verify', 'news', 'article-detail', 'profile', 'project-management', 'project-detail', 'system-chat', 'owner-profile', 'company-monitoring'],
  [ROLES.STAFF]: ['staff-dashboard', 'my-tasks', 'project-management', 'project-detail', 'upload-documents', 'candidate-review', 'company-profiles', 'partner-management', 'competitor-management', 'ai-extracted-data', 'search-companies', 'personal-ai-agent', 'ai-training-mode', 'learning-center', 'companies', 'company-detail', 'relationship-assessment-detail', 'partner-ecosystem', 'add-company', 'ai-agent', 'news', 'article-detail', 'profile', 'system-chat', 'owner-profile', 'staff-monitoring'],
};
