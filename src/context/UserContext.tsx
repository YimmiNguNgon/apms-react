...
export const ROLE_PAGES: Record<Role, string[]> = {
  ...
  [ROLES.OWNER]: ['owner-dashboard', 'partner-ecosystem', 'competitor-intelligence', 'project-management', 'project-detail', 'company-profiles', 'companies', 'company-detail', 'score-rules', 'audit-logs', 'system-settings', 'news', 'profile', 'system-chat'],
  [ROLES.DIRECTOR]: ['director-dashboard', 'risk-monitoring', 'partner-ecosystem', 'competitor-intelligence', 'relationship-map', 'market-opportunities', 'ai-recommendations', 'strategic-reports', 'score-rules', 'audit-logs', 'companies', 'company-profiles', 'company-detail', 'news', 'profile', 'project-management', 'project-detail', 'system-chat'],
